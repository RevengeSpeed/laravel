...
<head>
    ...
    <title>Mi Perfil - {{ $user->formacionAcademica->Nombre }} {{ $user->formacionAcademica->Apellido }}</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css">
</head>
<body>
    <div class="container mt-4">
        <h2 class="mb-4">Datos obtenidos</h2>
        <div class="card">
            <div class="card-body">
                @if ($user->profile_picture)
                    <img src="{{ $user->profile_picture }}" alt="Foto de {{ $user->formacionAcademica->Nombre }} {{ $user->formacionAcademica->Apellido }}" class="user-image mb-3">
                @else
