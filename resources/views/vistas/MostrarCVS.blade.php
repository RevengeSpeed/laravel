...
@section('content')
    <div class="container mt-4">
        ...
        <form action="{{ route('vistas.MostrarCVS') }}" method="GET" class="mb-4">
            <input type="text" name="query" placeholder="Buscar por habilidades..." class="form-control"
                value="{{ request('query') }}">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                @if($h->user)
                                    <a href="{{ route('vistas.InformacionUsuarioCVS', $h->user->id) }}" class="btn btn-primary">
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('vistas.InformacionUsuarioCVS', $user->id) }}" class="btn btn-primary">
                                        Mostrar toda la información
                                    </a>
                                </div>
                            </div>
